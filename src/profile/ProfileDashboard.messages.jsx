...
const messages = defineMessages({
  'profile.dashboard.memberSince': {
    id: 'profile.dashboard.memberSince',
    defaultMessage: 'Member since {date}',
    description: 'Member since date message',
  },
  ...
  'profile.dashboard.progress': {
    id: 'profile.dashboard.progress',
    defaultMessage: 'Overall Progress',
    description: 'Overall progress label',
  },
  'profile.dashboard.active': {
    id: 'profile.dashboard.active',
